...
class PartnersResponseSchema(BaseModel):
    """Schema for partners response."""
    ...
    partners: List[PartnerSchema] = Field(default_factory=list, description="List of partners")

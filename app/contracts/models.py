...
contract = Table(
    ...
    Column("contract_type_id_client", Integer, nullable=True),
    Column("contract_type_id_investor", Integer, nullable=True),
...
property_table = Table(
    ...
    Column("property_owner", String(255), nullable=True),
    Column("owner_civil_status", String(255), nullable=True),
    Column("owner_document_number", String(255), nullable=True),
    Column("owner_nationality", String(255), nullable=True),

...
class PropertyCreate(BaseModel):
    ...
    property_owner: Optional[str] = Field(None, max_length=255, description="Propietario de la propiedad")
    owner_civil_status: Optional[str] = Field(None, max_length=255, description="Estado civil del propietario")
    owner_document_number: Optional[str] = Field(None, max_length=255, description="Número de documento del propietario")
    owner_nationality: Optional[str] = Field(None, max_length=255, description="Nacionalidad del propietario")
    currency: str = Field("USD", max_length=3, description="Código de moneda")
...
class PropertyUpdate(BaseModel):
    ...
    property_owner: Optional[str] = Field(None, max_length=255)
    owner_civil_status: Optional[str] = Field(None, max_length=255)
    owner_document_number: Optional[str] = Field(None, max_length=255)
    owner_nationality: Optional[str] = Field(None, max_length=255)
    currency: Optional[str] = Field(None, max_length=3)
